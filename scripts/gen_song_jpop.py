...
OUT_PATH = os.path.join(os.path.dirname(__file__), "..", "songs", "cppsong1_jpop.mp3")
...
PROMPT = """Genre: bright energetic J-pop, ~150 BPM, anime opening theme energy.
Instruments: driving electric guitar, synth arps, punchy pop drums, bright synth bass, layered synth pads.
Vocals: Bright Female Pop Alto lead singer, energetic and slightly over-the-top delivery, big catchy melodic hooks, sung (not spoken), English lyrics with a J-pop vocal phrasing style.
...
print("Requesting J-pop song from lyria-3-pro-preview ...", file=sys.stderr)
