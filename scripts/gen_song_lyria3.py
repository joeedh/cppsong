...
OUT_PATH = os.path.join(os.path.dirname(__file__), "..", "songs", "cppsong1_lyria3.mp3")
...
PROMPT = """Genre: upbeat outlaw/honky-tonk country, ~120 BPM, live tavern bar-band energy.
Instruments: acoustic guitar, banjo, fiddle, upright bass, brushed drums.
Vocals: Deep Male Baritone lead singer, twangy comedic country delivery, full melody, sung (not spoken).
...
print("Requesting song from lyria-3-pro-preview ...", file=sys.stderr)
